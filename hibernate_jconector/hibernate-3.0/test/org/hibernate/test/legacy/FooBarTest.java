//$Id: FooBarTest.java,v 1.28 2005/03/16 02:45:46 steveebersole Exp $
...
public class FooBarTest extends TestCase {
	...
	public void testFindByCriteria() throws Exception {
		...
		List list = s.createCriteria(Foo.class).add(
	...
	public void testPersistCollections() throws Exception {
		...
		assertTrue( s.iterate("select count(*) from Bar b").next().equals( new Integer(0) ) );
