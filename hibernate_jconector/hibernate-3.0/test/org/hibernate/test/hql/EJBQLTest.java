//$Id: EJBQLTest.java,v 1.18 2005/02/27 07:42:19 oneovthafew Exp $
...
public class EJBQLTest
	...
	public void testEJBQLFunctions() throws Exception {
		String hql = "select object(a) from Animal a where a.description = concat('1', concat('2', '3'))";
		parse( hql, false );
	...
	private void assertEjbqlEqualsHql(String ejbql, String hql) {
		...
		QueryTranslator queryTranslator = ast.createQueryTranslator( hql, Collections.EMPTY_MAP, factory );
		queryTranslator.compile( Collections.EMPTY_MAP, true );
		String hqlSql = queryTranslator.getSQLString();

		queryTranslator = ast.createQueryTranslator( ejbql, Collections.EMPTY_MAP, factory );
		queryTranslator.compile( Collections.EMPTY_MAP, true );
	...
	private void parse(String input, boolean logging) throws RecognitionException, TokenStreamException {
		if ( logging ) {
