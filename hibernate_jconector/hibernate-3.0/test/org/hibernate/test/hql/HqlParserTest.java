// $Id: HqlParserTest.java,v 1.16 2005/03/29 03:04:25 oneovthafew Exp $
...
public class HqlParserTest extends TestCase {
	 ...
	 */
	private static final Log log = LogFactory.getLog( HqlParserTest.class );
...
//        parse("from sm in class org.hibernate.test.SubMulti where exists sm.children.elements");
	...
	private void doParse(String input, boolean filter) throws RecognitionException, TokenStreamException {
