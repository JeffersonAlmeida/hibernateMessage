// $Id: Dom4jAccessorTest.java,v 1.3 2005/02/21 05:35:11 oneovthafew Exp $
...
/**
 * Implementation of Dom4jAccessorTest.
 *
...
public class Dom4jAccessorTest extends TestCase {
	...
	public void testStringElementExtraction() throws Throwable {
		...
		Getter getter = PropertyAccessorFactory.getPropertyAccessor( property, EntityMode.DOM4J ).getGetter( null, null );
	...
	public void testCompanyElementGeneration() throws Throwable {
		...
		.getSetter( null, null );
		Setter accountIdSetter = PropertyAccessorFactory.getPropertyAccessor( generateAccountIdProperty(), EntityMode.DOM4J )
				.getSetter(null, null);
	...
	private static Element generateTestElement() {
		...
		System.out.println("Returning DOM : " + company.asXML() );
