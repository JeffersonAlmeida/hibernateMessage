...
public class MSSQLTest extends TestCase {
	...
	public void testScalarStoredProcedure() throws HibernateException, SQLException {
		...
		statement.execute("CREATE PROCEDURE simpleScalar @j int\r\n" + 
				"AS\r\n" + 
	...
	public void testParameterHandling() throws HibernateException, SQLException {
		...
		Statement statement = s.connection().createStatement();
		statement.execute("CREATE PROCEDURE paramHandling @j int, @i int\r\n" + 
				"AS\r\n" + 
	...
	public void testEntityStoredProcedure() throws HibernateException, SQLException {
		...
		Statement statement = s.connection().createStatement();
		statement.execute("CREATE PROCEDURE selectAllEmployments AS\n" + 
				" SELECT EMPLOYEE, EMPLOYER, \n" + 
				" STARTDATE, ENDDATE, \n" +
				" REGIONCODE, EID, VALUE, CURRENCY \n" +
			    " FROM EMPLOYMENT;");				
		statement.close();
		Query namedQuery = s.getNamedQuery("selectAllEmployees_MSSP");
		List list = namedQuery.list();
