...
public class ValueVisitorTest extends TestCase {
	...
	static public class ValueVisitorValidator implements ValueVisitor {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.hibernate.mapping.ValueVisitor#accept(org.hibernate.mapping.QueryList)
		 */
		public Object accept(QueryList list) {
			return validate(QueryList.class, list);
	...
	public void testProperCallbacks() {
		...
		new OneToOne(null,null).accept(vv);
		new PrimitiveArray(null).accept(vv);
		new QueryList(null).accept(vv);
