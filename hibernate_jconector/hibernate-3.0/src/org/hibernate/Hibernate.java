//$Id: Hibernate.java,v 1.15 2005/03/24 19:26:01 oneovthafew Exp $
...
public final class Hibernate {
	 ...
	 * Note: if you test on a invalid property the method will always return true.
	 * No existing-checking is performed.
	 *
	 * @param entity a persistable object
	 * @return true if the argument is not listed as uninitialized
	 */
	public static boolean isPropertyInitialized(Object entity, String propertyName) {
		if ( entity instanceof InterceptFieldEnabled ) {
			FieldInterceptor fieldInterceptor = ( FieldInterceptor ) ( ( InterceptFieldEnabled ) entity ).getInterceptFieldCallback();
