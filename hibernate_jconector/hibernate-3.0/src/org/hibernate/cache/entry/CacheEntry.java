...
public final class CacheEntry implements Serializable {
	...
	public CacheEntry(Object[] state, EntityPersister persister, boolean unfetched, SessionImplementor session, Object owner) 
	...
	throws HibernateException {
		...
		PreLoadEvent preLoadEvent = new PreLoadEvent(session).setEntity(result)
				.setState(assembledProps).setId(id).setPersister(persister);
