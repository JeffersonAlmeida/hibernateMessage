//$Id: MultipleHiLoPerTableGenerator.java,v 1.9 2005/03/30 18:01:41 oneovthafew Exp $
 ...
 * <p/>
 * <p>This implementation is not compliant with a user connection
 * <p/>
 *
 * <p>Allowed parameters:
 * <ul>
 * <li>table: table name (default GEN_TABLE, as stated by the EJB3 specs)</li>
 * <li>pkColumnName: key column name (default GEN_KEY, as stated by the EJB3 specs)</li>
 * <li>valueColumnName: hi value column name(default GEN_VALUE, as stated by the EJB3 specs)</li>
 * <li>key: key value for the current entity (default to default)</li>
 * <li>keySize: length of the varchar column in DB (default to 255)</li>
 * </ul>
 *
...
public class MultipleHiLoPerTableGenerator 
	...
	public void configure(Type type, Properties params, Dialect dialect) throws MappingException {
		...
		this.keySize = PropertiesHelper.getInt(PK_LENGTH_NAME, params, DEFAULT_PK_LENGTH);
