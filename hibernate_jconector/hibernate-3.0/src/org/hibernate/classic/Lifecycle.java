//$Id: Lifecycle.java,v 1.1 2004/07/28 03:33:33 oneovthafew Exp $
 ...
 * <br>
 * <tt>onSave()</tt>, <tt>onDelete()</tt> and <tt>onUpdate()</tt> are intended
 * to be used to cascade saves and deletions of dependent objects. This is an
 * alternative to declaring cascaded operations in the mapping file.<br>
 * <br>
