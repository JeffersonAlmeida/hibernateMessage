//$Id: SimpleValue.java,v 1.19 2005/03/11 15:20:05 oneovthafew Exp $
...
public class SimpleValue implements KeyValue {
	...
	throws MappingException {
		...
		if (entityName!=null) {
			params.setProperty(IdentifierGenerator.ENTITY_NAME, entityName);
		}
		
		//init the table here instead of earlier, so that we can get a quoted table name
		//TODO: would it be better to simply pass the qualified table name, instead of
		//      splitting it up into schema/catalog/table names
		params.setProperty( PersistentIdentifierGenerator.TABLE, getTable().getQuotedName(dialect) );
