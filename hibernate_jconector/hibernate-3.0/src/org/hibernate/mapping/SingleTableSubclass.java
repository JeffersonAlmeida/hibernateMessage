//$Id: SingleTableSubclass.java,v 1.4 2005/02/12 07:19:26 steveebersole Exp $
...
public class SingleTableSubclass extends Subclass {
    ...
    public void validate(Mapping mapping) throws MappingException {
        if(getDiscriminator()==null) {
            throw new MappingException("No discriminator found for " + getEntityName() + ". Discriminator is needed when 'single-table-per-hiearchy' is used and a class has subclasses");
        }
