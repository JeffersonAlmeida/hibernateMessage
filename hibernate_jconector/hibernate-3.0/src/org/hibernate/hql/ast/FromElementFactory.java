// $Id: FromElementFactory.java,v 1.46 2005/03/27 00:22:14 pgmjsd Exp $
...
class FromElementFactory implements SqlTokenTypes {
	...
	FromElement createEntityJoin(String entityClass,
								 String tableAlias,
...
//		elem.getOrigin().addDestination(elem); // Add the new node as a child of the origin.
		return elem;
	}
