//$Id: QueryTranslatorImpl.java,v 1.13 2005/03/17 05:50:09 oneovthafew Exp $
...
public class QueryTranslatorImpl extends BasicLoader
		implements QueryTranslator, FilterTranslator {
	...
	private void renderSQL() throws QueryException, MappingException {
		...
		for ( int i = 0; i < size; i++ ) {
			...
			ownerAssociationTypes[i] = (AssociationType) uniqueKeyOwnerReferences.get( name );
		}
