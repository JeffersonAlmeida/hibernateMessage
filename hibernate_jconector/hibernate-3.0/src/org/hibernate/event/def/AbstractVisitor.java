//$Id: AbstractVisitor.java,v 1.6 2005/03/04 10:52:21 oneovthafew Exp $
...
public abstract class AbstractVisitor {
	...
	AbstractVisitor(SessionImplementor session) {
	...
	final Object processValue(Object value, Type type) throws HibernateException {
		...
		if ( type.isCollectionType() ) {
			...
			return processQueryList( (List) value, (QueryType) type );
		}
		else {
			return null;
		}
