//$Id: DefaultEvictEventListener.java,v 1.4 2005/02/22 03:09:34 oneovthafew Exp $
...
public class DefaultEvictEventListener extends AbstractEventListener implements EvictEventListener {
	...
	throws HibernateException {
		...
		Cascades.cascade(session, persister, object, Cascades.ACTION_EVICT, Cascades.CASCADE_AFTER_EVICT);
	}
}
