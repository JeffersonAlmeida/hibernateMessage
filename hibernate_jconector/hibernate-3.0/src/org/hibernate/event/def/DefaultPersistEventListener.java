// $Id: DefaultPersistEventListener.java,v 1.2 2005/02/22 03:09:34 oneovthafew Exp $
...
public class DefaultPersistEventListener extends AbstractSaveEventListener implements PersistEventListener {
	...
	public void onPersist(PersistEvent event, Map createCache) throws HibernateException {
		...
		switch (entityState) {
			case DETACHED: 
				throw new PersistentObjectException( "detached entity passed to persist: " + event.getEntityName() );
			case PERSISTENT:
			...
			case TRANSIENT:
				...
				break;
			default: 
				throw new ObjectDeletedException( "deleted entity passed to persist", null, event.getEntityName() );
		}
