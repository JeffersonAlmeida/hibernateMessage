//$Id: PersistentIndexedElementHolder.java,v 1.5 2005/02/21 02:08:45 oneovthafew Exp $
...
public abstract class PersistentIndexedElementHolder extends AbstractPersistentCollection {
	...
	throws HibernateException, SQLException {
		Object object = persister.readElement( rs, owner, getSession() );
		final Type elementType = persister.getElementType();
		...
		final Object indexValue = persister.readIndex( rs, getSession() );
	...
	throws HibernateException {
		...
		deletes.keySet().removeAll( ( (HashMap) snapshot(persister) ).keySet() );
